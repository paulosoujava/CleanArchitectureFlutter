...
import 'package:clean_architecture/presentetion/presenters/presenters.dart';
import 'package:clean_architecture/presentetion/protocols/protocols.dart';
...
void main() {
  ...
  PostExpectation mockSaveCurrentAccount() => when(saveCurrentAccount.save(any));
